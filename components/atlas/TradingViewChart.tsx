  ...
  useEffect(() => {
    ...
    script.innerHTML = JSON.stringify({
      ...
      overrides: {
        ...
        'paneProperties.background':                        '#161310',
        'paneProperties.backgroundType':                    'solid',
        'paneProperties.vertGridProperties.color':          '#2E2A22',
        'paneProperties.horzGridProperties.color':          '#2E2A22',
        'scalesProperties.textColor':                       '#B8AD98',
      },
    })
