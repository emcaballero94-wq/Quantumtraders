...
const COPY = {
  en: {
    ...
    grid: [
      { label: 'CHARTS', desc: 'Live charts & structure' },
      { label: 'CORRELATIONS', desc: 'Sectors & DXY' },
      { label: 'GAMMA', desc: 'Gamma exposure' },
      { label: 'RISK', desc: 'Risk & calendar' },
      { label: 'ROADMAP', desc: 'Levels & certification' },
      { label: 'OVERVIEW', desc: 'Command cockpit' },
    ],
  },
  es: {
    ...
    grid: [
      { label: 'CHARTS', desc: 'Gráficos y estructura' },
      { label: 'CORRELATIONS', desc: 'Sectores y DXY' },
      { label: 'GAMMA', desc: 'Gamma exposure' },
      { label: 'RISK', desc: 'Riesgo y calendario' },
      { label: 'ROADMAP', desc: 'Niveles y certificación' },
      { label: 'OVERVIEW', desc: 'Cockpit de comando' },
    ],
  },
} as const
